...
export default defineConfig({
  ...
  projects: [
    ...
    // Feature 008: operations executed with their effect read back independently.
    { name: "functional", testMatch: /functional-.*\.spec\.ts/, use: { baseURL: `http://localhost:${irisPort}/flightdeck/` } },
